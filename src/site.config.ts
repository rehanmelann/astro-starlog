...
const config: SiteConfig = {
  ...
  tags: ['Cybersecurity', 'Incident Response', 'Threat Intelligence'],
  ...
  navLinks: [
    ...
    {
      name: 'Resume',
      url: 'https://chadporter.net/resume.pdf',
      external: true,
    },
  ],
  ...
  socialLinks: {
    email: 'mailto:me@chadporter.net',
    gitlab: 'https://gitlab.com/chadporter',
    github: 'https://chadaporter.net/githubbub',
    linkedin: 'https://linkedin.com/in/chadporterdev',
    keybase: 'https://keybase.io/chadaporter',
